                  	...
                  	<form action="emp_insert.php" method="post">
						<!--begin::Body-->
							<div class="card-body">
								...
								<div class="row mb-3">
									<label for="monthLebel" class="form-label">Month</label>
									<div class="col-sm-10">
										<?php
											$all_month_arr = array(1 => "January", 2 => "February", 3 => "March", 4 => "April", 5 => "May", 6 => "June", 
															7 => "July", 8=>"August", 9 =>"September", 10 =>"October", 11 =>"November", 12 =>"December");
										?>
										<select name="month" class="form-control" id="monthLebel">
											<option value="0">Select Month</option>
											<?php
												foreach($all_month_arr as $key => $monthName) {
												if($key ==  $row['month_id']) {
													$selected = "selected";
												} else {
													$selected = "";
